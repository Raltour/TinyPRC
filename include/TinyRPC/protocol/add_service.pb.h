...
#ifndef GOOGLE_PROTOBUF_INCLUDED_add_5fservice_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_add_5fservice_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_add_5fservice_2eproto
...
struct TableStruct_add_5fservice_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_add_5fservice_2eproto;
namespace rpc {
class AddRequest;
...
class AddRequest final :
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_add_5fservice_2eproto;
};
// -------------------------------------------------------------------
...
class AddService_Stub;

class AddService : public ::PROTOBUF_NAMESPACE_ID::Service {
 protected:
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(AddService);
};

class AddService_Stub : public AddService {
 public:
  AddService_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);
  AddService_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel,
 ...
 private:
  ...
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(AddService_Stub);
};
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_add_5fservice_2eproto
