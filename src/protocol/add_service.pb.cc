...
const char descriptor_table_protodef_add_5fservice_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
...
const ::_pbi::DescriptorTable descriptor_table_add_5fservice_2eproto = {
    ...
    file_level_metadata_add_5fservice_2eproto, file_level_enum_descriptors_add_5fservice_2eproto,
    file_level_service_descriptors_add_5fservice_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_add_5fservice_2eproto_getter() {
  return &descriptor_table_add_5fservice_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_add_5fservice_2eproto(&descriptor_table_add_5fservice_2eproto);
namespace rpc {
...
::PROTOBUF_NAMESPACE_ID::Metadata AddRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      ...
      file_level_metadata_add_5fservice_2eproto[0]);
}
