...
const uint32_t TableStruct_echo_5fservice_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::rpc::EchoRequest, _impl_.sentence_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::rpc::EchoResponse, _impl_.result_),
};
...
const char descriptor_table_protodef_echo_5fservice_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\022echo_service.proto\022\003rpc\"\037\n\013EchoRequest"
  "\022\020\n\010sentence\030\001 \001(\t\"\036\n\014EchoResponse\022\016\n\006re"
  "sult\030\001 \001(\t2:\n\013EchoService\022+\n\004Echo\022\020.rpc."
  "EchoRequest\032\021.rpc.EchoResponseB\003\200\001\001b\006pro"
  "to3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_echo_5fservice_2eproto = {
    false, false, 163, descriptor_table_protodef_echo_5fservice_2eproto,
    "echo_service.proto",
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "rpc.EchoRequest.sentence"));
        } else
          goto handle_unusual;
        continue;
      default:
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "rpc.EchoResponse.result"));
        } else
          goto handle_unusual;
        continue;
      default:
...
void EchoService::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
  ...
  switch(method->index()) {
    case 0:
      Echo(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::rpc::EchoRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::rpc::EchoResponse*>(
                 response),
             done);
      break;
    default:
