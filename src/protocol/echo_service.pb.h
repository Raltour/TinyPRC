...
// string sentence = 1;
inline void EchoRequest::clear_sentence() {
  _impl_.sentence_.ClearToEmpty();
}
inline const std::string& EchoRequest::sentence() const {
  // @@protoc_insertion_point(field_get:rpc.EchoRequest.sentence)
  return _internal_sentence();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void EchoRequest::set_sentence(ArgT0&& arg0, ArgT... args) {
 
 _impl_.sentence_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:rpc.EchoRequest.sentence)
}
inline std::string* EchoRequest::mutable_sentence() {
  std::string* _s = _internal_mutable_sentence();
  // @@protoc_insertion_point(field_mutable:rpc.EchoRequest.sentence)
  return _s;
}
inline const std::string& EchoRequest::_internal_sentence() const {
  return _impl_.sentence_.Get();
}
inline void EchoRequest::_internal_set_sentence(const std::string& value) {
  
  _impl_.sentence_.Set(value, GetArenaForAllocation());
}
inline std::string* EchoRequest::_internal_mutable_sentence() {
  
  return _impl_.sentence_.Mutable(GetArenaForAllocation());
}
inline std::string* EchoRequest::release_sentence() {
  // @@protoc_insertion_point(field_release:rpc.EchoRequest.sentence)
  return _impl_.sentence_.Release();
}
inline void EchoRequest::set_allocated_sentence(std::string* sentence) {
  if (sentence != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:rpc.EchoRequest.sentence)
}
...
inline const std::string& EchoResponse::result() const {
  // @@protoc_insertion_point(field_get:rpc.EchoResponse.result)
...
void EchoResponse::set_result(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.result_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:rpc.EchoResponse.result)
}
inline std::string* EchoResponse::mutable_result() {
  std::string* _s = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:rpc.EchoResponse.result)
  return _s;
}
...
inline std::string* EchoResponse::release_result() {
  // @@protoc_insertion_point(field_release:rpc.EchoResponse.result)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:rpc.EchoResponse.result)
}
