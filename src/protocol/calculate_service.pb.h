...
inline int32_t SubResponse::_internal_result() const {
  return _impl_.result_;
}
inline int32_t SubResponse::result() const {
  // @@protoc_insertion_point(field_get:rpc.SubResponse.result)
  return _internal_result();
}
inline void SubResponse::_internal_set_result(int32_t value) {
  
  _impl_.result_ = value;
}
inline void SubResponse::set_result(int32_t value) {
  _internal_set_result(value);
  // @@protoc_insertion_point(field_set:rpc.SubResponse.result)
}
